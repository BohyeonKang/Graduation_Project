...
HD_PWD='/home/esoc/broadwise/vivado/projects/eyeriss/xpr/eyeriss_wrapper_ip/eyeriss_wrapper_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eyeriss_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eyeriss_top.tcl
