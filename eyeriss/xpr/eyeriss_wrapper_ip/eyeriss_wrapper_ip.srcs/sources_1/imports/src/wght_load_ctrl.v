...
module wght_load_ctrl(
    ...
    assign o_wght_glb_ra = (cnt_P * i_layer_s * i_layer_s * i_layer_q) + (cnt_R * i_layer_s) + (cnt_Q * i_layer_s * i_layer_s) + cnt_S;
    ...
    wire pass_done = (cnt_P == i_layer_p - 1) && (cnt_S == i_layer_s - 1) &&
                (cnt_Q == i_layer_q - 1) && (cnt_R == i_layer_s - 1);
