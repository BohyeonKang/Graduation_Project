...
HD_PWD='C:/LAB/Graduation_Project/eyeriss_0626/eyeriss_0626.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PE_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PE_array.tcl
